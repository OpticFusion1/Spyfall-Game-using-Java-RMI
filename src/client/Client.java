...
public class Client  extends UnicastRemoteObject implements ClientInterface
{
	...
	public Client(UI aChatGUI, String userName, String ipAddress) throws RemoteException 
        {
		super();
        ...
        {
            System.out.println(username + ": from class Client" );
...
//            System.setProperty("java.rmi.server.hostname","192.168.137.175");
...
//			serverIF = ( ServerInterface )Naming.lookup("rmi://" + "192.168.0.26:1099" + "/" + serviceName);
                        serverIF = ( ServerInterface )Naming.lookup("rmi://" + hostName + ":1099/" + serviceName);
                        serverIF.proxyBind(this, username);
                        ConnectionInterface conn = serverIF.giveConnection();
        ...
        {
            chatGUI.showStatistics(statistics);
        }
        
        public void updatePlayerNumber(int playerNumber) throws RemoteException
        {
            chatGUI.updatePlayerNumber(playerNumber);
        }
	...
	public void refreshTheList(String[] currentUsers) throws RemoteException 
        ...
        public void disableEverything()
        {
            ...
            chatGUI.startButton.setEnabled(true);
        }    
}
